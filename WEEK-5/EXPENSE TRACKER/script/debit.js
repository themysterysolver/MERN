document.addEventListener("DOMContentLoaded",()=>{
    document.querySelector("form").addEventListener("submit",(e)=>{
        ...
        let category=document.getElementById("debit_drop").value;
        let note=document.getElementById("note").value;
        let type="Debit";
        if((parseFloat(localStorage.getItem("balance"))||0)-amount<0){
            alert(`Insufficent balance,your current balance is ${parseFloat(localStorage.getItem("balance"))||0}`);
            return;
        }
